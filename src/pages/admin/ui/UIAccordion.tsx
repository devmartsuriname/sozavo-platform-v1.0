      ...
      <div className="row">
        ...
        <div className="col-lg-6">
          <DarkoneCard 
            title="Basic Example" 
            titleTag="h5"
            subtitle={<>Using the card component, you can extend the default collapse behavior to create an accordion. To properly achieve the accordion style, be sure to use <code>.accordion</code> as a wrapper.</>}
          >
        ...
        <div className="col-lg-6">
          <DarkoneCard 
            ...
            titleTag="h5"
            subtitle={<>Add <code>.accordion-flush</code> to remove the default <code>background-color</code>, some borders, and some rounded corners to render accordions edge-to-edge with their parent container.</>}
          >
        ...
        <div className="col-lg-6">
          <DarkoneCard 
            ...
            titleTag="h5"
            subtitle={<>Omit the <code>data-bs-parent</code> attribute on each <code>.accordion-collapse</code> to make accordion items stay open when another item is opened.</>}
          >
